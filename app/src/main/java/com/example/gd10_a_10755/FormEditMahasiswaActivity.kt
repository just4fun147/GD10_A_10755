...
import com.example.gd10_a_10755.databinding.ActivityFormEditMahasiswaBinding
...
class FormEditMahasiswaActivity : AppCompatActivity() {
    private lateinit
    var binding : ActivityFormEditMahasiswaBinding
    ...
    private fun dateToString(year: Int, month: Int, dayofMonth: Int): String { return year.toString()+"-"+(month+1)+"-"+dayofMonth.toString() }
