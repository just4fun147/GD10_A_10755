...
import com.example.gd10_a_10755.databinding.ActivityMainBinding
import com.example.gd10_a_10755.fragment.DataMahasiswaFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showDataFragment()
        binding.txtCari.setOnKeyListener(View.OnKeyListener{
