package com.example.gd10_a_10755
...
import com.example.gd10_a_10755.databinding.ActivityDetailMahasiswaBinding
...
class DetailMahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnEdit.setOnClickListener {
            startActivity(Intent(this, FormEditMahasiswaActivity::class.java).apply { putExtra("nim",nim)
            })
        }
    }
    ...
    fun deleteData(nim:String){
        ...
        builder.setMessage("Anda Yakin mau hapus?? Saya ngga yakin loh.") .setCancelable(false) .setPositiveButton("Ya, Hapus Aja!"){
